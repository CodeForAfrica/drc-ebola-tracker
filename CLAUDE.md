...
- **i18n:** this redesign is **English-only** — the 🌐 button is decorative and the previous trilingual (EN/FR) system was not carried over. Re-adding French is a follow-up if wanted.
